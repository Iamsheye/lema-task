...
export const Textarea = forwardRef<HTMLTextAreaElement, TextareaProps>(
  ({ error, className = "", ...props }, ref) => {
    const baseClassName =
      "flex resize-none rounded border bg-white px-4 py-2.5 text-sm leading-normal placeholder:text-text-placeholder focus:ring-2 focus:ring-slate-950 focus:outline-none";
    const errorClassName = error ? "border-red-500" : "border-border-light";
